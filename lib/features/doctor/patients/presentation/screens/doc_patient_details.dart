              ...
              children: [
                GradientCard(
                  ...
                  children: [
                    ...
                    // national id
                    Padding(
                        padding: EdgeInsets.only(left: width * 0.05),                    child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text('national_id:' , style: GoogleFonts.poppins(
                                fontSize: 16,
                                color: Color(0x66ffffff),
                              ),),
                              Text(patient["national_id"] ?? "", style: GoogleFonts.poppins(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Color(0xffffffff),
                              ),)
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(patient["date_of_birth"] ?? "" , style: GoogleFonts.poppins(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Color(0xffffffff),
                              ),)
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(patient["registered_on"] ?? "" , style: GoogleFonts.poppins(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Color(0xffffffff),
                              ),)
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(patient["medical_history"] ?? "" , style: GoogleFonts.poppins(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Color(0xffffffff),
                              ),)
                ...
                GradientCard(width: width*.8, height:height*.37,children: [
                  Padding(
                    padding: EdgeInsets.symmetric(
                      horizontal: width * 0.05,
                      vertical: height * 0.02,
                  ...
                  Padding(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                            Text('Disease type' , style: GoogleFonts.poppins(
                            fontSize: 16,
                            color: Color(0x66ffffff),
                          ),),
                          Text("Diabetes" , style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Color(0xffffffff),
                          ),)
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text("10/5/2025" , style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Color(0xffffffff),
                          ),)
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text("moderate" , style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Color(0xffffffff),
                          ),)
                  ...
                  Padding(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('confidence' , style: GoogleFonts.poppins(
                            fontSize: 16,
                            color: Color(0x66ffffff),
                          ),),
                          Text("84%" , style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Color(0xffffffff),
                          ),)
